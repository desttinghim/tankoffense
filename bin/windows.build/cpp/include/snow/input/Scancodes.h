...
#define INCLUDED_snow_input_Scancodes

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS2(snow,input,Scancodes)
namespace snow{
namespace input{
...
class HXCPP_CLASS_ATTRIBUTES  Scancodes_obj : public hx::Object{
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("Scancodes"); }
...
#endif /* INCLUDED_snow_input_Scancodes */ 
