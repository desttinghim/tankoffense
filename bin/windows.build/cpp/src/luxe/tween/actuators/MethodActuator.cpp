		...
		HX_STACK_LINE(71)
		{
			...
			while((true)){
				...
				if (((  ((!(::Std_obj::is(start,hx::ClassOf< ::Float >())))) ? bool(::Std_obj::is(start,hx::ClassOf< ::Int >())) : bool(true) ))){
					HX_STACK_LINE(80)
					::luxe::tween::actuators::PropertyDetails _g2 = ::luxe::tween::actuators::PropertyDetails_obj::__new(this->tweenProperties,propertyName,start,(this->properties->__Field(HX_CSTRING("end"),true)->__GetItem(i) - start),null());		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(80)
					details = _g2;
					HX_STACK_LINE(81)
